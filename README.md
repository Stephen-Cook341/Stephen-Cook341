...
## Tech Stack
[![My Skills](https://skillicons.dev/icons?i=js,html,css,mysql,sqlite,cpp,cs,java,kotlin,python,pytorch,tensorflow,ai,arduino,raspberrypi,latex,md,docker,github,githubactions,bash,powershell,windows,linux,ubuntu,arch,kali,windows,vscodium&perline=12)](https://skillicons.dev)
